...
<head>
    ...
    <style>
        ...
        .card-stat:hover { 
            ...
            box-shadow: 0 20px 45px rgba(66, 57, 38, 0.1); 
        ...
        .card-stock { 
            ...
            border-radius: 24px; 
            box-shadow: 0 12px 30px rgba(66, 57, 38, 0.25); 
            height: 100%; 
            display: flex; 
            flex-direction: column; 
            justify-content: space-between; 
        ...
        .form-control:focus, .form-select:focus { 
            ...
            box-shadow: 0 0 0 4px rgba(70, 71, 4, 0.15) !important; 
            outline: none; 
        }
        ...
        /* SLIDER DE DISTRIBUCIÓN ADAPTADO */
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card-stat">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="fw-bold text-subtle mb-0 text-uppercase" style="letter-spacing: 1px;">
    ...
    <div class="table-container table-responsive">
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex flex-wrap gap-2">
                            <span class="badge rounded-pill fs-6 shadow-sm border" style="background-color: var(--brand-info); color: white; border-color: var(--brand-info) !important;" title="Leche Apta">
                        ...
                        <div class="mt-2 text-subtle small fw-bold">
                    ...
                    <td>
                        ...
                        <% } else { %>
                            ...
                            <div class="mt-1 small text-subtle fw-bold">
                ...
                %>
                <tr><td colspan="5" class="text-center py-5 text-subtle"><i class="bi bi-inbox fs-1 d-block mb-3 opacity-50"></i>No hay registros para el periodo seleccionado.</td></tr>
                <% } %>
            </tbody>
        </table>
    </div>
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body px-4 py-4">
                ...
                <div class="row g-3 mb-4 text-center">
                    <div class="col-4 border-end" style="border-color: var(--border-subtle) !important;"><h5 class="fw-bolder text-brand"><%= o.getTotalLitros() %> L</h5><span class="text-subtle small fw-bold">APTO COMERCIAL</span></div>
                    <div class="col-4 border-end" style="border-color: var(--border-subtle) !important;"><h5 class="fw-bolder text-danger"><%= o.getTotalDescarte() %> L</h5><span class="text-subtle small fw-bold">DESCARTE</span></div>
                    <div class="col-4"><h5 class="fw-bolder text-dark"><%= o.getTotalVacas() %></h5><span class="text-subtle small fw-bold">VACAS ORDEÑADAS</span></div>
                </div>
                    ...
                    <table class="table align-middle m-0">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td><span class="badge rounded-pill fs-6 px-4 py-2 shadow-sm" style="background-color: var(--brand-info); color: white;"><%= d.getLitrosObtenidos() %> L</span></td>
                            </tr>
                            <% } %>
                        </tbody>
                    </table>
                ...
                <div class="modal-body px-4 py-4">
                    ...
                    <div class="table-responsive table-custom-wrapper shadow-sm mb-3">
                        <table class="table align-middle m-0">
                            ...
                            <tbody id="tbodyVacas">
                                <tr id="emptyRow"><td colspan="4" class="text-center text-subtle py-5"><i class="bi bi-basket fs-2 d-block mb-2 opacity-50"></i>Aún no has añadido ninguna vaca a este ordeño.</td></tr>
                            </tbody>
                        </table>
                    </div>
